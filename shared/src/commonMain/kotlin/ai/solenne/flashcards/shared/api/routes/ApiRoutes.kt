package ai.solenne.flashcards.shared.api.routes
...
object ApiRoutes {
    ...
    const val MOBILE_CLIENTS = "solenne-flashcards://callback"
    ...
    const val AUTH_GOOGLE_CALLBACK_ANDROID = "$AUTH_BASE/google/callback/android"
