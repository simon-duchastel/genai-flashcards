...
gcloud run deploy flashcards-server \
    ...
    --set-env-vars=GOOGLE_OAUTH_REDIRECT_URI=https://api.flashcards.solenne.ai/api/v1/auth/google/callback,GOOGLE_OAUTH_TEST_REDIRECT_URI=https://api.flashcards.solenne.ai/api/v1/auth/google/test/callback
