package ai.solenne.flashcards.server

import ai.solenne.flashcards.server.auth.AppleOAuthService
import ai.solenne.flashcards.server.auth.GoogleOAuthService
import ai.solenne.flashcards.server.config.FirestoreConfig
import ai.solenne.flashcards.server.plugins.*
import ai.solenne.flashcards.server.repository.FirestoreAuthRepository
import ai.solenne.flashcards.server.repository.ServerFlashcardRepository
import ai.solenne.flashcards.server.storage.FirestoreRateLimiter
import ai.solenne.flashcards.server.storage.FirestoreStorage
